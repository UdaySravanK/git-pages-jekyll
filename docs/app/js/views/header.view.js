...
define([
    ...
    'underscore',
    'backbone',
    'js/models/header.model',
    'router',
    'text!templates/header.html'
], function ($, Page, Global, _, Backbone, HeaderModel, Router, headerTpl) {
    /**
     * CONSTRUCTOR
     ***************************************************************************/
    var Header = Page.extend({
        ...
        renderView: function () {
            ...
            this.compiledTemplate = _.renderPartial(self.templates['headerTpl'], this.model.tplData);
